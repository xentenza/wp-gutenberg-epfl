...
require_once 'epfl-news-mosaic/controller.php';
...
function wp_gutenberg_epfl_register_blocks() {
	...
	register_block_type( 'epfl/mosaic-panel', array(
		'render_callback' => 'EPFL\Plugins\Gutenberg\Mosaic\epfl_mosaic_panel_block',
	));

    register_block_type( 'epfl/mosaic-deck', array(
		'render_callback' => 'EPFL\Plugins\Gutenberg\Mosaic\epfl_mosaic_deck_block',
	));
